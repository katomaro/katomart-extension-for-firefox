document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("katomartize-button")
...
function updateData() {
  ...
  deleteBtn.addEventListener("click", (event) => {
    window.alert("cookies deletados com sucesso");
  });
}
